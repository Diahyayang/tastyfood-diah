...
<body class="h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-700 to-blue-500">
...
<div class="relative z-10 w-[360px] pt-16 pb-8 px-8 rounded-2xl 
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <!-- Button -->
        <button type="submit"
            class="w-full bg-blue-900 hover:bg-blue-800 py-2 rounded-md font-semibold tracking-wide shadow-lg transition">
            LOGIN
        </button>
